...
class GUI(Tk):
    def __init__(self):
        super().__init__()
        # Status bar variable
        self.back_image = PhotoImage(file="zeta_halo.png")
        self.back_image2 = PhotoImage(file="zeta_halo.png")
        ...
        self.msg_box = Text(self.background_label, height=5, width=50, font=('Arial', 12), bg="grey")
